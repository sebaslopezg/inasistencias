...
(function (factory) {
  ...
  $.ui.focusable = function (element, hasTabindex) {
    ...
    return (
      focusableIfVisible && $(element).is(":visible") && $(element).css("visibility") === "visible"
    );
  };
  ...
  $.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      this.isMultiLine =
        isTextarea || (!isInput && this.element.prop("contentEditable") === "true");
    ...
    $.ui.formResetMixin,
    {
      ...
      _documentClick: {
        mousedown: function (event) {
          ...
          if (
            !$(event.target).closest(".ui-selectmenu-menu, #" + CSS.escape(this.ids.button)).length
          ) {
            this.close(event);
          }
        }
